...
class  UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = {
        ...
        # IsAuthenticatedOrReadOnly, can read if niot authenticated but cannot modifiy data if not authenticated
        IsAuthenticated  #cannot read nither modify data if not authenticated
    }
